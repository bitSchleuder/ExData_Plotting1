...
# Top left
with(subData, plot(Global_active_power ~ Datetime, type = "l", ylab = "Global Active Power", xlab = NA))
# TOP right
with(subData, plot(Voltage ~ Datetime, type = "l", ylab = "Voltage", xlab = NA))
# BOTTOM left
...
# BOTTOM right
with(subData, plot(Global_reactive_power ~ Datetime, type = "l", xlab = NA))
# Finish
dev.off()